...
import { selectBookMarkItems } from "../../redux/slice/bookMarkSlice";
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
                {getListBookMark.length <= 0 ? (
                    <div className="text-base w-full">
                        <p className="font-bold text-xl">You haven't bookmark any anime</p>
                        <button className="bg-[#AD241B] hover:bg-[#ad4b44] py-2">
